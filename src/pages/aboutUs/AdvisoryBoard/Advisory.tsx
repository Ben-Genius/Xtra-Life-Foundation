    ...
    <div className="overflow-hidden">
      ...
      >
        <div className="p-3 md:p-5 w-full mb-3 flex flex-col items-center h-full justify-center relative">
          ...
          <h1 className="font-bold sm:max-w-full text-4xl sm:6xl  text-center font-sans">FOR THE FUTURE GHANA ADVISORY BOARD </h1>

        </div>
</div>
          <section className="max-w-full sm:max-w-[94%] mx-auto">
          <div className=" p-10 bg-blue-500 mt-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4 w-full gap-4 mt-12">
